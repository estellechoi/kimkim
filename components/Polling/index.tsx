...
const Polling = ({ formattedNumber, caption, status = 'neutral', className, isLoading }: PollingProps) => {
  ...
  return (
    <div className={`${className} flex items-center gap-x-2.5 ${textColorClassName}`}>

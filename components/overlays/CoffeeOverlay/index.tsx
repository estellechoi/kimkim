...
const CoffeeOverlay = (props: Omit<OverlayProps, 'ariaLabel'>) => {
  ...
  const Content = (
    <>
      <p className="text-caption Font_body_xs mb-5">
        KimKim 앱이 도움이 되셨다면, 커피 한 잔 사주세요! <br /> 기부금으로{' '}
        <span className="text-body">전송하실 네트워크를 반드시 확인해주세요.</span>
      </p>
      ...
      <p className="text-caption Font_body_xs mb-14">
        ...
        <ul className="list-disc list-outside pl-4">
          <li>앱/웹사이트 프로덕트 전략</li>
          <li>브랜딩, 사용자 경험 리서치 및 프로덕트 디자인</li>
          <li>정보위계 설계</li>
          <li>디자인 시스템</li>
          <li>앱/웹사이트 개발</li>
          <li>블록체인 기술을 활용한 프로덕트 개발 (Ethereum, Cosmos 생태계 DeFi 및 CeFi)</li>
        </ul>
      </p>

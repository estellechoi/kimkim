...
const ExchangeDropDownLabel = ({ exchange }: { exchange: Exchanges }) => {
  return (
    <div className="flex items-center gap-x-2 Font_label_12px">
...
const ExchangeDropDownPair = ({
  baseExchange = Exchanges.UPBIT,
  quoteExchange = Exchanges.BINANCE,
  onBaseExchangeChange,
  onQuoteExchangeChange,
  className = '',
}: ExchangeDropDownPairProps) => {
  return (

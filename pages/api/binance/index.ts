...
import { HmacSHA256, HmacSHA512, enc } from 'crypto-js';
...
export const getBinanceSignaturedParams = (secretKey: string, params: { recvWindow: string; timestamp: string } & Record<string, string>): { signature: string; [key: string]: string } => {
